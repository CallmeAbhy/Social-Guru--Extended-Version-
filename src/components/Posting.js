...
function onSelect2(selectedList, selectedItem){
  ...
  useEffect(() => {
    axios.get(`http://100.25.193.158:4000/client/find/?email=${value}`)
    .then(response => {
...
const[knowloc,setKnowloc] = useState();
  ...
  const postjob = (event) => {
    ...
    axios.post("http://100.25.193.158:4000/jobs/save", database)
    .then(response => {
      console.log(response);
...
useEffect(() => {
  axios.get('http://100.25.193.158:4000/jobs/city/')
  .then((response) =>{
    console.log(response);
...
useEffect(() => {
  axios.get('http://100.25.193.158:4000/jobs/skills/')
  .then(response => {
    console.log(response);
